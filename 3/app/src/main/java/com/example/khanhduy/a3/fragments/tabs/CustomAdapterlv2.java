...
public class CustomAdapterlv2 extends BaseAdapter {
    // khai báo biến
    String [] result;
    Context context;
    int [] imageId;
    ...
    public CustomAdapterlv2(Context context1, String[] prgmNameList, int[] prgmImages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View rowView;
        rowView = inflater.inflate(R.layout.customv2, null);
